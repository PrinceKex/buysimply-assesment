...
let User = class User {
    toDto() {
        var _a, _b;
        const dto = new user_type_1.UserDto();
        dto.id = this.id;
        dto.email = this.email;
        dto.first_name = this.first_name;
        dto.last_name = this.last_name;
        dto.role_id = ((_a = this.role) === null || _a === void 0 ? void 0 : _a.id) || null;
        dto.role_code = ((_b = this.role) === null || _b === void 0 ? void 0 : _b.code) || null;
